...
struct ArmorParam
{
    ...
    ArmorParam()
    {
        ...
        light_width_height_ratio = 0.8;//0.7
        ...
        //小装甲板
        small_armor_max_aspect_ratio = 2.5;
        small_armor_min_aspect_ratio = 1.4;
        //大装甲板
...
public:
    ~ArmorDetect(){}
    int armordetect();
    bool findarmor(Mat frame, KalmanFilter KF, Mat measurement, int count);
    void produce();
    void consume();
    void streamoff();


    //bool numsDetectSVM(Mat frame, string xmlPath);
bool numsDetectSVM(Mat frame, string filename);
...
//    string xmlPath = "/home/dji/Desktop/findarmor_2023/xmlFile/SVM.xml";
//    string xmlPath = "/home/dji/Desktop/findarmor_2023/xmlFile/mnist_svm.xml";
//    string xmlPath = "/home/dji/Desktop/findarmor_2023/xmlFile/SVM2.xml";
    string xmlPath = "/home/dji/Desktop/findarmor_2023/xmlFile/SVM3.xml";
